...
const UsersTable = () => {
	...
	useEffect(() => {
		const fetchUsers = async () => {
			try {
				const res = await fetch("https://admin-dashboard-arca-backend.vercel.app/dashboard/userInfo", { method: "GET" });
		...
		const fetchRoles = async () => {
			try {
				const res = await fetch("https://admin-dashboard-arca-backend.vercel.app/dashboard/roles", { method: "GET" });
				const data = await res.json();
	...
	const handleUserUpdate = async (updatedUser) => {
		try {
			const res = await fetch(`https://admin-dashboard-arca-backend.vercel.app/dashboard/updateUser/${updatedUser.id_usuario}`, {
				method: "PATCH",
				headers: {
	...
	const handleUserCreate = async (e) => {
		e.preventDefault();
		try {
			const res = await fetch("https://admin-dashboard-arca-backend.vercel.app/dashboard/createUser", {
				method: "POST",
