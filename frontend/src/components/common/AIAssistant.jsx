...
const QUICK_ACTIONS = [
    { label: "¿Cómo ingresar material?", prompt: "¿Cómo puedo ingresar nuevo material al inventario?" },
    { label: "Realizar una venta", prompt: "¿Cómo registro una venta de material?" },
    { label: "Registrar donación", prompt: "¿Cómo registro una donación?" },
    { label: "Ver inventario", prompt: "¿Cómo puedo consultar el inventario actual?" },
    { label: "Generar reporte", prompt: "¿Cómo genero un reporte de movimientos?" },
  ];
