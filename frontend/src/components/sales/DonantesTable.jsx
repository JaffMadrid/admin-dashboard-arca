...
const DonantesTable = () => {
  ...
  const handleDonanteUpdate = async (updatedDonante) => {
    try {
      const res = await fetch(
        `https://admin-dashboard-arca-backend.vercel.app/dashboard/updateDonante/${updatedDonante.id_donante}`,
        {
          method: "PATCH",
          headers: {
  ...
  const handleDonanteCreate = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://admin-dashboard-arca-backend.vercel.app/dashboard/createDonante",
        {
          method: "POST",
